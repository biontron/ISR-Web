	...
	},
	{
		...
		items: [
			...
			},
			{
				kind: "field",
				order: 2,
				dataStructure: { itemName: "collapsed", default: "false" },
				formProperties: { label: { und: "Collapsed", de: "Eingeklappt" } },
				fieldType: "boolean",
				itemFlags: fieldFlags,
				minUsage: 0,
				maxUsage: 1,
			},
			{
				kind: "field",
				order: 3,
				dataStructure: { itemName: "titleTemplate", default: "" },
				formProperties: { label: { und: "Title template", de: "Titelvorlage" } },
				fieldType: "string",
				itemFlags: fieldFlags,
				minUsage: 0,
				maxUsage: 1,
